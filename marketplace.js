...
const authenticatedRequest = got.extend({
    prefixUrl: `https://api.3dplatforma.ru/api`,
    headers: {
...
const getIframeCode = async (url) => {
        ...
        json: {
            data: {
                ...
                attributes: {
                    ...
                    logo: false, // Show 3D Platform logo
                    analytics: true, // Enable analytics
                    autorotate: true, // Start automatic rotation
                    // ... any other params as defined in API doc
                },
            },
        },
    });
    ...
    //   src="https://api.3dplatforma.ru/api/player/2724daa5-cb68-43f9-8d5a-36be7e06f88d/embedded?autorun=1&closebutton=1&hidecontrols=0&logo=1&hidefullscreen=0" >
    // </iframe>
    return { id, html };
};
...
(async () => {
    ...
    try {
        const { id, html } = getIframeCode('https://3dplatforma.ru/3dplatforma/9636a6c3-64e5-4054-8def-a8c185389a1e');
